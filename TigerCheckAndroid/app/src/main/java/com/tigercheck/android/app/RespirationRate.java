/*
-----------------------------------------------------------------------------
RespirationRate.java
Date Created: 4/20/2014
Date Last Modified: 4/22/2014
Author of Last Change: Nick Bean

Function: This is the station for entering Respiration Rate data.
...
public class RespirationRate extends ActionBarActivity {
...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_respiration_rate);
    }
...
*/
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.respiration_rate, menu);
        return true;
    }
...
________________________________________________________________
*/
    public void respirationSubmitted(View v)
    {
