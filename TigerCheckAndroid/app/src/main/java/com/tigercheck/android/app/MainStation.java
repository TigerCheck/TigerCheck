...
public class MainStation extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        /** Complex way I found on internet
        Button submitButton = (Button) findViewById(R.id.submitButton);
        submitButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v)
            {
                Intent intent = new Intent (v.getContext(), StationSelect.class);
                startActivityForResult(intent, 0);
            }
        });*/

		/** Zach's code not sure what it does right now
    ...
    // The way zach does it, which is better?
    public void onMainStationSubmit (View view) {
        // Check to see if valid barcode at this point
        // If valid barcode do the following below
        Intent intent = new Intent(this, StationSelect.class);
        startActivity(intent);
        // If not throw a message box stating invalid barcode
    }
}
